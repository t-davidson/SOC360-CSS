...
# Course updates
- Homework 2 due Friday, end of day
  - Submit homework via Github
  - Add link to Canvas once submitted
...
write_csv(texts, "../data/marxdurkheim.csv")
```
...
write_csv(words, '../data/words.csv')
```
...
# Trigams
Excercise: Modify `unnest_tokens` to construct trigrams. 
