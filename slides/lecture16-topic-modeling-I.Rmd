...
# Course updates
- Homework 2 grades and proposal feedback now available on Canvas
    - See Github diff for comments on Homework 2
...
## Loading the corpus
Loading a corpus of most recent 2000 tweets by the New York Times and the Wall Street Journal. TODO: Change if needed
...
get_top_docs_and_words <- function(t, n_docs = 3, n_words = 10) {
    ...
    top_docs <- documents %>% arrange(desc(gamma)) %>%
