...
summary(prep, topics = c(20, 30,38)) # show results for selected topics
```
...
```{r, eval=FALSE, echo=FALSE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
plot(prep, "day", method = "continuous", topics = c(20, 30, 38), model = fit, xaxt = "n", xlab = "Day in March 2022", 
     labeltype = "custom", custom.labels = c("President", "Supreme Court","Plane Crash"))
```
...
```{r, eval=FALSE, echo=FALSE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
plot(fit, type="perspectives", topics=20)
```

# Structural Topic Modeling
## Content by publication
```{r, eval=FALSE, echo=FALSE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
plot(fit, type="perspectives", topics=30)
```
# Structural Topic Modeling
## Content by publication
```{r, eval=FALSE, echo=FALSE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
plot(fit, type="perspectives", topics=38)
```
