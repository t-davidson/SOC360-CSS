...
# Course updates
## Homework 3
- Homework 3 on NLP will be released today on Canvas
    - Due next Wednesday at 5pm
...
## Inspecting topics
```{r, eval=FALSE, echo=TRUE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
labelTopics(fit, topics=40, n=10)
```
...
```{r, eval=FALSE, echo=FALSE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
plot(prep, "year", method = "continuous", topics = c(3, 4, 40), model = fit, xlab = "Year", 
     labeltype = "custom", custom.labels = c("Labor", "Agriculture", "Health"))
```

# Structural Topic Modeling
## Content by party
```{r, eval=FALSE, echo=FALSE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
plot(fit, type="perspectives", topics=40)
```
...
## Content by party
```{r, eval=FALSE, echo=FALSE, tidy=FALSE, mysize=TRUE, size='\\footnotesize'}
plot(fit, type="perspectives", topics=4)
```
