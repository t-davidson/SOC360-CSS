...
- Homework 4 released after class, due next Thursday 11/20
...
- Project Prototype submission
    ...
    - Link to data and code on Github
        - Add my username as collaborator if using a private repository
        
# Course updates
## Projects
- In-class project workshops
    - 11/20 (next Thursday), and 12/4 (Thursday)
