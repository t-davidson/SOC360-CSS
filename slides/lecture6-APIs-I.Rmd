...
# Course updates
## No class Wednesday
- At-home workshop on using the Spotify API
    - Work through the examples and complete an optional extra credit assignment
    - You will need a Spotify API account for Homework 2
