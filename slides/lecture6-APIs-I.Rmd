...
# Course updates
## Homework
- Homework 1 released last week, due Thursday at 5pm.
...
# APIs
## Best-practices
- Use a "wrapper" package if available (Thursday's lecture)
...
# APIs
## The post-API age?
- Following Facebook's decision to close down access to its Pages API, Deen Freelon writes:
...
# APIs
## The post-API age?
- Current access on major social media platforms
    - Meta recently shutdown CrowdTangle, which provided data on Pages and Groups
    - Twitter Academic API provided extensive access but shut down after Musk takeover
    - Reddit had a permissive system but closed access to monetize data for large language model training
    - Restrictive conditions for TikTok academic access
    - Spotify has limited access to some endpoints
