...
Website: \href{https://github.com/t-davidson/css-spring-2022}{https://github.com/t-davidson/css-spring-2022} and Canvas.

Class meetings: Monday & Thursday 10:20-11:40am, Allison Road Classroom 204, Busch Campus.

Office hours: Monday 5:00-6:00 p.m, 109 Davison Hall, Douglass Campus or by appointment.
...
- Develop proficiency in data merging, cleaning, analysis, and visualization
...
- 30% Final project
    - Students will complete a final project involving the use of RShiny to build an interactive web application for data analysis and visualization. Students may work individually or as part of a group. The project will include a written report and a presentation.
...
## *Assignment 1 released: Using R to Analyze and Model Social Dynamics.*
...
- Thursday 3/28: 
    - Grimmer, Justin, Margaret E. Roberts, and Brandon M. Stewart. 2021. “Machine Learning for Social Science: An Agnostic Approach.” *Annual Review of Political Science* 24(1)
...
- Monday 4/1:
    - Barberá, Pablo, Amber E. Boydstun, Suzanna Linn, Ryan McMahon, and Jonathan Nagler. 2020. “Automated Text Classification of News Articles: A Practical Guide.” *Political Analysis*, June, 1–24.
- Thursday 4/4: 
...
- Monday 4/8 (No class due to travel, but please read the following)
...
- Monday 4/15:
    - Torres, Michelle, and Francisco Cantú. 2021. “Learning to See: Convolutional Neural Networks for the Analysis of Social Science Data.” *Political Analysis*, April, 1–19.
...
- Monday 4/29 (last day of classes)
    - Presentations
